...
import dataset from HorseZebraDataset
import sys
...
def train_fn(disc_H, disc_Z, gen_H, gen_Z, loader, opt_disc, opt_gen, L1, MSE, d_scaler, g_scaler):
    ...
    for idx, (zebra, horse) in enumerate(loop):
        ...
        with torch.cuda.amp.autocast():
            ...
            # cycle loss
            cycle_zebra = gen_Z(fake_horse) # 循环
...
def main():
    ...
    val_dataset = HorseZebraDataset(
        root_horse="cycle_test/horse1", root_zebra="cycle_test/zebra1", transform=config.transforms
    )
